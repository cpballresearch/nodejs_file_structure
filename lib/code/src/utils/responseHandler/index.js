 ...
 */
const handleServerError = async (res, error, statusCode = Constants.HTTPINTERNALSERVERERROR) => {
...
const handleCustomErrorResponse = async (res, httpStatusCode, message) => {
    const response = new ResponseEntity(null, httpStatusCode, Constants.failedStatus, message);
...
const handelBadRequest = async (res) => {
    const response = new ResponseEntity(null, Constants.HTTPBADREQUEST, Constants.failedStatus, Constants.invalidData);
    res.status(200).json(response);
}
...
const handelTooMayRequest = async (res) => {
    const response = new ResponseEntity(null, Constants.HTTPTOOMANYREQUEST, Constants.failedStatus, Constants.TOOMANYREQUEST);
    res.status(200).json(response);
}

//* Export all functions
export {
    createResponse, handelBadRequest, handelDataDelete, handelDataInvalid, handelDataNotFound, handelDataUnique, handelDataUpdate, handelExistEmail, handelImageNotFound, handelInvalidEmail, handelLogin, handelServerDataCreated,
    handelServerDataGet, handelServerSuccess, handelTooMayRequest, handelUnauthorized, handelUnverifyEmail, handleCustomErrorResponse, handleServerError, handleSuccessCustomResponse
};
