...
export default (router)=>{
    ...
    router.put("/toggleActiveUser/:id",authenticateToken,UserController.toggleActive);
    router.delete("/toggleDeleteUser/:id",authenticateToken,UserController.toggleDelete);
