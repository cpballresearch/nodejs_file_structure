...
function generateStructure() {
  ...
  const codeFiles = [
    ...
    {
      src: "code/src/controllers/user.controller.js",
      dest: "src/controllers/user.controller.js"
    },
    {
      src: "code/src/middleware/authHashPassword.js",
      dest: "src/middleware/authHashPassword.js"
    },
    {
      src: "code/src/middleware/authMiddleware.js",
      dest: "src/middleware/authMiddleware.js"
    },
    {
      src: "code/src/middleware/errorHandelerMiddleware.js",
      dest: "src/middleware/errorHandelerMiddleware.js"
    },
    {
      src: "code/src/middleware/fileuploader.middleware.js",
      dest: "src/middleware/fileuploader.middleware.js"
    },
    {
      src: "code/src/models/tables/user.model.js",
    ...
    {
      src: "code/src/repositories/user.repository.js",
    ...
    {
      src: "code/src/security/requestInterceptorDataValidation.js",
      dest: "src/security/requestInterceptorDataValidation.js"
    },
    { src: "code/src/security/session.js", dest: "src/security/session.js" },
    {
      src: "code/src/services/user.service.js",
      dest: "src/services/user.service.js"
    },
    {
      src: "code/src/utils/responseHandler/index.js",
      dest: "src/utils/responseHandler/index.js"
    },
    {
      src: "code/src/utils/responseHandler/ResponseEntity.js",
